...
class Payment_Activation(models.Model):
    ...
    admin_user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='admin_payment_activation', to_field="username", on_delete=models.CASCADE, blank=True, null=True)
    ...
    award_letter = models.CharField(max_length= 5000, blank=True, null=True)
